...
VALUES
    ...
    (4, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 4', '작품에 대한 설명', 30000, 'ON_SALE', 14, 1, NULL, 1, NULL, 'PRD004', 10, 20, 30, 5),
    ...
    (8, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 8', '작품에 대한 설명', 25000, 'ON_SALE', 18, 2, NULL, 2, NULL, 'PRD008', 10, 20, 30, 4),
    ...
    (12, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 12', '작품에 대한 설명', 20000, 'ON_SALE', 12, 0, NULL, 0, NULL, 'PRD012', 10, 20, 30, 3),
    ...
    (16, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 16', '작품에 대한 설명', 15000, 'ON_SALE', 16, 1, NULL, 1, NULL, 'PRD016', 10, 20, 30, 2),
    ...
    (20, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 20', '작품에 대한 설명', 10000, 'ON_SALE', 10, 2, NULL, 2, NULL, 'PRD020', 10, 20, 30, 1),
    ...
    (24, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 24', '작품에 대한 설명', 30000, 'ON_SALE', 14, 0, NULL, 0, NULL, 'PRD024', 10, 20, 30, 5),
    ...
    (28, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 28', '작품에 대한 설명', 25000, 'ON_SALE', 18, 1, NULL, 1, NULL, 'PRD028', 10, 20, 30, 4),
    ...
    (32, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 32', '작품에 대한 설명', 20000, 'ON_SALE', 12, 2, NULL, 2, NULL, 'PRD032', 10, 20, 30, 3),
    ...
    (36, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 36', '작품에 대한 설명', 15000, 'ON_SALE', 16, 0, NULL, 0, NULL, 'PRD036', 10, 20, 30, 2),
    ...
    (40, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 40', '작품에 대한 설명', 10000, 'ON_SALE', 10, 1, NULL, 1, NULL, 'PRD040', 10, 20, 30, 1),
    ...
    (44, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 44', '작품에 대한 설명', 30000, 'ON_SALE', 14, 2, NULL, 2, NULL, 'PRD044', 10, 20, 30, 5),
    ...
    (48, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 48', '작품에 대한 설명', 25000, 'ON_SALE', 18, 0, NULL, 0, NULL, 'PRD048', 10, 20, 30, 4),
...
INSERT INTO ITEM (ITEM_ID, CREATED_AT, UPDATED_AT, NAME, DESCRIPTION, PRICE, SALE_STATUS, STOCK, WISH_COUNT, AVERAGE_RATING, REVIEW_COUNT, TOTAL_RATING, PRODUCT_CODE, WIDTH, HEIGHT, DEPTH, ARTIST_ID)
VALUES
    (51, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 51', '작품에 대한 설명', 15000, 'ON_SALE', 11, 0, 3.0, 0, 0.0, 'PRD051', 10, 20, 30, 2),
    (52, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 52', '작품에 대한 설명', 20000, 'ON_SALE', 12, 1, NULL, 1, NULL, 'PRD052', 10, 20, 30, 3),
    (53, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 53', '작품에 대한 설명', 25000, 'ON_SALE', 13, 2, 4.0, 2, 8.0, 'PRD053', 10, 20, 30, 4),
    ...
    (56, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 56', '작품에 대한 설명', 15000, 'ON_SALE', 16, 2, NULL, 2, NULL, 'PRD056', 10, 20, 30, 2),
    ...
    (60, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 60', '작품에 대한 설명', 10000, 'ON_SALE', 10, 0, NULL, 0, NULL, 'PRD060', 10, 20, 30, 1),
    ...
    (64, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 64', '작품에 대한 설명', 30000, 'ON_SALE', 14, 1, NULL, 1, NULL, 'PRD064', 10, 20, 30, 5),
    ...
    (68, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 68', '작품에 대한 설명', 25000, 'ON_SALE', 18, 2, NULL, 2, NULL, 'PRD068', 10, 20, 30, 4),
    ...
    (72, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 72', '작품에 대한 설명', 20000, 'ON_SALE', 12, 0, NULL, 0, NULL, 'PRD072', 10, 20, 30, 3),
    ...
    (76, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 76', '작품에 대한 설명', 15000, 'ON_SALE', 16, 1, NULL, 1, NULL, 'PRD076', 10, 20, 30, 2),
    ...
    (80, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 80', '작품에 대한 설명', 10000, 'ON_SALE', 10, 2, NULL, 2, NULL, 'PRD080', 10, 20, 30, 1),
    ...
    (84, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 84', '작품에 대한 설명', 30000, 'ON_SALE', 14, 0, NULL, 0, NULL, 'PRD084', 10, 20, 30, 5),
    ...
    (88, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 88', '작품에 대한 설명', 25000, 'ON_SALE', 18, 1, NULL, 1, NULL, 'PRD088', 10, 20, 30, 4),
    ...
    (92, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 92', '작품에 대한 설명', 20000, 'ON_SALE', 12, 2, NULL, 2, NULL, 'PRD092', 10, 20, 30, 3),
    ...
    (96, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 96', '작품에 대한 설명', 15000, 'ON_SALE', 16, 0, NULL, 0, NULL, 'PRD096', 10, 20, 30, 2),
    ...
    (100, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 100', '작품에 대한 설명', 10000, 'ON_SALE', 10, 1, NULL, 1, NULL, 'PRD100', 10, 20, 30, 1);
