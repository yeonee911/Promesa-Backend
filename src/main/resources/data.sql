...
INSERT INTO ITEM (
    ITEM_ID, CREATED_AT, UPDATED_AT, NAME, PRICE, SALE_STATUS, STOCK, WISH_COUNT, ARTIST_ID)
VALUES
    (1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '빈티지 블랙 높은잔 세트', 10000, 'ON_SALE', 10, 1, 1),
    (2, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 2', 25000, 'ON_SALE', 1, 0, 1),
    (3, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 3', 10000, 'ON_SALE', 14, 0, 2),
    (4, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 4', 20000, 'ON_SALE', 10, 1, 1),
    (5, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 5', 10000, 'ON_SALE', 2, 1, 2),
    (6, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 6', 25000, 'ON_SALE', 13, 0, 2),
    (7, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 7', 15000, 'ON_SALE', 4, 0, 2),
    (8, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 8', 25000, 'ON_SALE', 13, 0, 1),
    (9, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 9', 15000, 'ON_SALE', 4, 0, 1),
    (10, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 10', 15000, 'ON_SALE', 11, 1, 2),
    (11, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 11', 25000, 'ON_SALE', 15, 1, 1),
    (12, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 12', 15000, 'ON_SALE', 5, 2, 3),
    (13, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 13', 15000, 'ON_SALE', 3, 1, 1),
    (14, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 14', 20000, 'ON_SALE', 17, 0, 2),
    (15, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 15', 15000, 'ON_SALE', 19, 0, 1),
    (16, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 16', 10000, 'ON_SALE', 8, 1, 1),
    (17, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 17', 10000, 'ON_SALE', 4, 0, 1),
    (18, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 18', 10000, 'ON_SALE', 12, 0, 1),
    (19, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 19', 10000, 'ON_SALE', 8, 0, 2),
    (20, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 20', 15000, 'ON_SALE', 6, 1, 1),
    (21, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 21', 25000, 'ON_SALE', 1, 2, 1),
    (22, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 22', 20000, 'ON_SALE', 17, 1, 3),
    (23, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 23', 25000, 'ON_SALE', 2, 1, 3),
    (24, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 24', 10000, 'ON_SALE', 3, 0, 1),
    (25, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 25', 15000, 'ON_SALE', 11, 2, 2),
    (26, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 26', 10000, 'ON_SALE', 8, 1, 1),
    (27, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 27', 20000, 'ON_SALE', 9, 1, 1),
    (28, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 28', 25000, 'ON_SALE', 3, 1, 1),
    (29, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 29', 10000, 'ON_SALE', 17, 2, 1),
    (30, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 30', 15000, 'ON_SALE', 17, 2, 1),
    (31, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 31', 10000, 'ON_SALE', 15, 1, 2),
    (32, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 32', 20000, 'ON_SALE', 3, 2, 1),
    (33, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 33', 20000, 'ON_SALE', 2, 1, 3),
    (34, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 34', 15000, 'ON_SALE', 14, 1, 1),
    (35, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 35', 20000, 'ON_SALE', 8, 0, 1),
    (36, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 36', 20000, 'ON_SALE', 19, 0, 3),
    (37, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 37', 15000, 'ON_SALE', 1, 1, 3),
    (38, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 38', 15000, 'ON_SALE', 18, 2, 1),
    (39, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 39', 25000, 'ON_SALE', 12, 0, 2),
    (40, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 40', 10000, 'ON_SALE', 2, 0, 3),
    (41, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 41', 25000, 'ON_SALE', 13, 0, 2),
    (42, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 42', 25000, 'ON_SALE', 13, 1, 3),
    (43, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 43', 20000, 'ON_SALE', 13, 2, 1),
    (44, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 44', 20000, 'ON_SALE', 9, 0, 3),
    (45, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 45', 25000, 'ON_SALE', 11, 1, 3),
    (46, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 46', 10000, 'ON_SALE', 16, 2, 2),
    (47, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 47', 20000, 'ON_SALE', 19, 2, 1),
    (48, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 48', 20000, 'ON_SALE', 15, 0, 3),
    (49, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 49', 15000, 'ON_SALE', 15, 0, 1),
    (50, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 50', 10000, 'ON_SALE', 17, 0, 2),
    (51, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 51', 10000, 'ON_SALE', 20, 2, 2),
    (52, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 52', 25000, 'ON_SALE', 5, 1, 1),
    (53, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 53', 10000, 'ON_SALE', 14, 1, 3),
    (54, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 54', 15000, 'ON_SALE', 1, 1, 3),
    (55, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 55', 25000, 'ON_SALE', 20, 0, 3),
    (56, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 56', 15000, 'ON_SALE', 8, 2, 1),
    (57, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 57', 25000, 'ON_SALE', 2, 2, 1),
    (58, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 58', 25000, 'ON_SALE', 12, 1, 2),
    (59, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 59', 15000, 'ON_SALE', 3, 1, 3),
    (60, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 60', 15000, 'ON_SALE', 7, 2, 1),
    (61, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 61', 15000, 'ON_SALE', 19, 2, 1),
    (62, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 62', 20000, 'ON_SALE', 6, 0, 1),
    (63, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 63', 10000, 'ON_SALE', 12, 1, 2),
    (64, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 64', 10000, 'ON_SALE', 2, 2, 1),
    (65, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 65', 20000, 'ON_SALE', 4, 2, 2),
    (66, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 66', 15000, 'ON_SALE', 16, 1, 2),
    (67, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 67', 10000, 'ON_SALE', 12, 1, 1),
    (68, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 68', 15000, 'ON_SALE', 6, 2, 3),
    (69, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 69', 15000, 'ON_SALE', 9, 0, 3),
    (70, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 70', 10000, 'ON_SALE', 11, 0, 1),
    (71, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 71', 25000, 'ON_SALE', 14, 0, 1),
    (72, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 72', 20000, 'ON_SALE', 10, 2, 2),
    (73, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 73', 15000, 'ON_SALE', 6, 2, 2),
    (74, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 74', 25000, 'ON_SALE', 4, 2, 2),
    (75, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 75', 10000, 'ON_SALE', 5, 2, 2),
    (76, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 76', 10000, 'ON_SALE', 2, 0, 2),
    (77, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 77', 15000, 'ON_SALE', 5, 0, 2),
    (78, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 78', 10000, 'ON_SALE', 9, 1, 2),
    (79, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 79', 15000, 'ON_SALE', 14, 1, 1),
    (80, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 80', 20000, 'ON_SALE', 8, 1, 3),
    (81, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 81', 20000, 'ON_SALE', 12, 2, 3),
    (82, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 82', 10000, 'ON_SALE', 12, 0, 3),
    (83, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 83', 25000, 'ON_SALE', 8, 0, 3),
    (84, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 84', 20000, 'ON_SALE', 6, 0, 2),
    (85, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 85', 10000, 'ON_SALE', 1, 0, 1),
    (86, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 86', 15000, 'ON_SALE', 2, 1, 1),
    (87, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 87', 25000, 'ON_SALE', 9, 0, 2),
    (88, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 88', 15000, 'ON_SALE', 18, 2, 1),
    (89, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 89', 25000, 'ON_SALE', 15, 0, 1),
    (90, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 90', 10000, 'ON_SALE', 16, 1, 3),
    (91, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 91', 10000, 'ON_SALE', 7, 0, 2),
    (92, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 92', 20000, 'ON_SALE', 15, 0, 3),
    (93, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 93', 15000, 'ON_SALE', 15, 2, 2),
    (94, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 94', 15000, 'ON_SALE', 15, 1, 1),
    (95, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 95', 15000, 'ON_SALE', 10, 2, 3),
    (96, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 96', 25000, 'ON_SALE', 2, 1, 1),
    (97, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 97', 20000, 'ON_SALE', 2, 0, 2),
    (98, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 98', 25000, 'ON_SALE', 13, 1, 2),
    (99, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 99', 25000, 'ON_SALE', 5, 1, 3),
    (100, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '작품 100', 10000, 'ON_SALE', 11, 1, 1);
    ;
